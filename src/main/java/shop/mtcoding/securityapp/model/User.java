...
@NoArgsConstructor // hibernate가 ORM시에 new하려고 필요하다
@Getter
@Table(name = "user_tb")
...
public class User {
    ...
    private LocalDateTime createdAt; // 회원가입날짜 LocalDateTime -> Timestamp 로 들어간다
    private LocalDateTime updateAt; // 회원수정한날짜
